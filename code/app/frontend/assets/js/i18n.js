(function () {
  ...
  const dictionaries = {
    ru: {
      ...
      driverTextTitle: "Тексты водительского киоска", driverTextLead: "Настройте заголовок и короткий текст под клавиатурой.",
      driverTitleLabel: "Заголовок", driverKeyboardNoteLabel: "Текст под клавиатурой",
    ...
    tg: {
      ...
      driverTextTitle: "Матнҳои киоски ронанда", driverTextLead: "Сарлавҳа ва матни кӯтоҳи зери клавиатураро танзим кунед.",
      driverTitleLabel: "Сарлавҳа", driverKeyboardNoteLabel: "Матни зери клавиатура",
