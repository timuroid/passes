(function () {
  ...
  const dictionaries = {
    ru: {
      ...
      oldFirst: "По дате: ранние сверху", newFirst: "По дате: новые сверху", visibility: "Видимость",
      allRecords: "Все", visibleRecords: "Видимые", hiddenRecords: "Скрытые", apply: "Применить", reset: "Сбросить",
      onPage: "На странице", vehicleNumber: "Номер автомобиля", submittedAt: "Получен", status: "Статус", actions: "Действия",
    ...
    tg: {
      ...
      oldFirst: "Аз рӯи сана: барвақт боло", newFirst: "Аз рӯи сана: нав боло", visibility: "Намоёнӣ",
      allRecords: "Ҳама", visibleRecords: "Намоён", hiddenRecords: "Пинҳон", apply: "Татбиқ", reset: "Тоза кардан",
      onPage: "Дар саҳифа", vehicleNumber: "Рақами автомобил", submittedAt: "Қабул шуд", status: "Ҳолат", actions: "Амалҳо",
